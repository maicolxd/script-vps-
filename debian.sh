...
echo "prueva        (crear cuenta de prueba)"  | tee -a log-install.txt
...
echo "Timezone : America/peru (GMT +7)"  | tee -a log-install.txt
echo "IPv6     : [off]"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "informacion"  | tee -a log-install.txt
echo "---------"  | tee -a log-install.txt
echo "VIP MSC"  | tee -a log-install.txt
